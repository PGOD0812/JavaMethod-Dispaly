 ...
 *
 *   - isOn(x,y)                Whether the point (x,y) is on of the disk
...
public class Disk {
    ...
    public String toString(){
        /*# YOUR CODE HERE */
       //return String.format("Disk center: (%f, %f) Damage level: %d", centerX, centerY, damage); // this is to make your code compile until you write this method.
        //return "Disk center: ("+centerX+", "+ centerY+") Damage level: " + damage;
        return centerX +" "+ centerY+ " " + damage;
    }
